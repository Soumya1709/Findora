...
export default function Navbar() {
  ...
  return (
    <motion.nav initial={{ opacity: 0, y: -30 }}animate={{ opacity: 1, y: 0 }}transition={{duration: 0.6,ease: "easeOut",}}className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
