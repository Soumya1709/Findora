        ...
        {["Browse", "Report", "Matching"].map((l) => (
          <a key={l} href="#"
            className={`px-3 py-1.5 rounded-lg font-medium transition-colors
              ${l === "Browse"
                ? "text-blue-600 font-semibold border-b-2 border-blue-600 rounded-none"
  ...
  return (
    ...
    >
      ...
      <div className="px-2 pb-4 space-y-0.5">
        ...
        <button className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-red-400 hover:bg-red-50 hover:text-red-600 transition-colors">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
